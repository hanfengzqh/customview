...
public class RefreshLayout2 extends ViewGroup {
    ...
    static class AnimListenerAdapter extends AnimatorListenerAdapter {
        private final WeakReference<RefreshLayout2> reference;

        AnimListenerAdapter(RefreshLayout2 view) {
        ...
        public void onAnimationCancel(Animator animation) {
            ...
            RefreshLayout2 view = reference.get();
            view.mFactor = 1;
        }
    ...
    static class AnimUpdateListener implements ValueAnimator.AnimatorUpdateListener {
        ...
        AnimUpdateListener(RefreshLayout2 view) {
            this.reference = new WeakReference<>(view);
        }
    ...
    private boolean isScroller() {
        View view = getChildAt(0);
        return view != null && ((view instanceof ScrollView) || (view instanceof WebView)  );
    }
