...
public class Xfermode2View extends View {
    ...
    public Xfermode2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        /**
         * view可以使用以下三个类型之一：
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawColor(Color.BLACK);//---最下面的一层
        /**
...
//        mPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_IN));
         ...
         */
        mPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_IN));
//        mPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.ADD));//饱和度想加
//        mPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.LIGHTEN));//变亮
//        mPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DARKEN));//变暗
//        mPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.MULTIPLY));//正片叠底
//        mPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.OVERLAY));//叠加
//        mPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SCREEN));//滤色
